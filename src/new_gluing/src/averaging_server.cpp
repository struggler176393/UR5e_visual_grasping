...
#include <new_gluing/AveragingAction.h>
...
protected:
  ...
  ros::NodeHandle nh_;
  actionlib::SimpleActionServer<new_gluing::AveragingAction> as_;
  std::string action_name_;
  int data_count_, goal_;
  float sum_, sum_sq_;
  new_gluing::AveragingFeedback feedback_;
  new_gluing::AveragingResult result_;
  ros::Subscriber sub_;
};
